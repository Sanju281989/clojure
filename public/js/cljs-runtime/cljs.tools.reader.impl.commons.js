...
var G__26727 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26727;
continue;
} else {
return ch;
...
var vec__26717 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26717,(0),null);
return (match === s);
});
...
var len__4864__auto___26738 = arguments.length;
var i__4865__auto___26739 = (0);
while(true){
if((i__4865__auto___26739 < len__4864__auto___26738)){
args__4870__auto__.push((arguments[i__4865__auto___26739]));

var G__26740 = (i__4865__auto___26739 + (1));
i__4865__auto___26739 = G__26740;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26723){
...
return (function() { 
var G__26744__delegate = function (rdr,_){
...
var G__26744 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__26746__i = 0, G__26746__a = new Array(arguments.length -  1);
while (G__26746__i < G__26746__a.length) {G__26746__a[G__26746__i] = arguments[G__26746__i + 1]; ++G__26746__i;}
  _ = new cljs.core.IndexedSeq(G__26746__a,0,null);
} 
return G__26744__delegate.call(this,rdr,_);};
...
var _ = cljs.core.rest(arglist__26747);
return G__26744__delegate(rdr,_);
});
