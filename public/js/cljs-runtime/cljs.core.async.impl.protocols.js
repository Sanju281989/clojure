...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26945 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26945(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26950 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26950(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26953 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26953(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26955 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26955(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26957 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26957(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26960 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26960(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26962 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26962(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26967 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26967(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26969 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26969(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26970 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26970(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26972 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26972(b);
}
});
