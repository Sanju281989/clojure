...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__37664){
var map__37666 = p__37664;
var map__37666__$1 = cljs.core.__destructure_map(map__37666);
var request = map__37666__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37666__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__37669 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37669.cljs$core$IFn$_invoke$arity$1 ? fexpr__37669.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37669.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__37670 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37670.cljs$core$IFn$_invoke$arity$1 ? fexpr__37670.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37670.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__37671){
var map__37672 = p__37671;
var map__37672__$1 = cljs.core.__destructure_map(map__37672);
var request = map__37672__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37672__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
