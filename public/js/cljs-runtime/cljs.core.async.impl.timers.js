...
var i_29938 = (self__.level + (1));
while(true){
if((i_29938 <= (new_level + (1)))){
(update[i_29938] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29940 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29940[i]));
} else {
x__$2.forward.push((((i < links_29940.length))?(links_29940[i]):null));
}

if((i < links_29940.length)){
(links_29940[i] = x__$2);
} else {
links_29940.push(x__$2);
}
...
var i_29942 = (0);
while(true){
if((i_29942 <= self__.level)){
var links_29943 = (update[i_29942]).forward;
if((x__$1 === (((i_29942 < links_29943.length))?(links_29943[i_29942]):null))){
(links_29943[i_29942] = (x__$1.forward[i_29942]));

var G__29944 = (i_29942 + (1));
i_29942 = G__29944;
continue;
} else {
var G__29945 = (i_29942 + (1));
i_29942 = G__29945;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__29953 = nx;
var G__29954 = (level__$1 - (1));
x = G__29953;
level__$1 = G__29954;
continue;
} else {
var G__29955 = x;
var G__29956 = (level__$1 - (1));
x = G__29955;
level__$1 = G__29956;
continue;
}
